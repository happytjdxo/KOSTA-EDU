...
<script type="text/javascript">
	...
	function recheck() {
		document.registerForm.buttonCheck.value="no";		
	}
</script>
</head>
<body>
...
<!--  폼에 값을 입력하고 전송 버튼을 누르면..자바스크립트로 연결...여기서 페이지 이동
       ...
       이건 자바스크립트로 일단 연결하겠다.
-->
<form action="front.do" method="post" name="registerForm" onsubmit="return registerData()">
<input type="hidden" name="command" value ="register">
아이디 :<input type="text" name="id" onfocus="return recheck()">
