...
<style type="text/css">
   ...
   #textarea{ margin-left: 23% ; outline-style: inherit; margin-top: 1%}
   #check{ margin-left: 35%; width: 20px; }
   #img{ width: 7% ; height: 7%; margin-left: 47%; margin-top: 2%}
   #btn{ margin-top: 1%}
...
<form>
<img id="img" alt="" src="../img/agreement.jpg">
    <div class="agreementForm1">
       <textarea id="textarea" cols="120" rows="20">
제 1 조 (목적)

이 약관은 오한자가 제공하는 오한자 및 오한자 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.


제 2 조 (정의)

이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
①'서비스'라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 '회원'이 이용할 수 있는 오한자 및 오한자 관련 제반 서비스를 의미합니다.
②회원이라 함은 회사의 '서비스'에 접속하여 이 약관에 따라 '회사'와 이용계약을 체결하고 '회사'가 제공하는 '서비스'를 이용하는 고객을 말합니다. 
...
②'회사'는 '가입신청자'의 신청에 대하여 '서비스' 이용을 승낙함을 원칙으로 합니다. 다만, '회사'는 다음 각 호에 해당하는 신청에 대하여는 승낙을 하지 않거나 사후에 이용계약을 해지할 수 있습니다. 1. 1.가입신청자가 이 약관에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 단 '회사'의 회원 재가입 승낙을 얻은 경우에는 예외로 함. 
...
제 11 조 ('회원'의 의무)
①'회원'은 다음 행위를 하여서는 안 됩니다. 1. 1.신청 또는 변경 시 허위내용의 등록 
2. 2.타인의 정보도용 
3. 3.'회사'가 게시한 정보의 변경 
...
제 12 조 ('서비스'의 제공 등)
①회사는 회원에게 아래와 같은 서비스를 제공합니다. 1. 1.검색 서비스 
...
③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다. 
    ...
    <div align="center" id="btn">
        <a href="register.jsp" class="btn btn-sm btn-success"><span class="glyphicon glyphicon-ok"></span>다음</a>
    </div>
</form>
</body>
</html>