...
<script type="text/javascript" src="../js/subpagemenu3.js"></script>
				...
				<div class="col-sm-3 col-md-2 sidebar">
					<ul class="nav nav-sidebar">
						<li class="active"><a href="#"><img
								src="../img/main/subMenu_alcohol_tip_btn/subpage3.jpg"> <span class="sr-only">(current)</span></a></li>
						<li><a href="#"><img id="subMenu1" src="../img/main/subMenu_alcohol_tip_btn/gametip.png"></a></li>
						<li><a href="#"><img id="subMenu2" src="../img/main/subMenu_alcohol_tip_btn/sulzaritip.png"></a></li>
					</ul>
