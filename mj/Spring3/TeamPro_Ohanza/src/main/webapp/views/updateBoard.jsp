...
<form action="board.do?command=updateBoard&&no=${boardDTO.no}" name="updateForm" method="post" class="form-horizontal" style="margin-left: 5%;">
...
<div class="form-group" style="margin: 10%;">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <textarea class="form-control" id="txtArea" name="content">
