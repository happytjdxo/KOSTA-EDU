...
<body>
	...
	<div class="container">
		...
		<form action="../member.do" name="updateForm" method="post" class="form-horizontal" style="border: 1.5px solid #22b14c;">
			...
			<div class="form-group" >
				...
				<div class="col-md-8" style="margin-top: 10px;">
					<input type="text" name="id" class="form-control" id="inputscreenname"
						 value="${sessionScope.dto.id}" readonly="readonly"/>
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<input type="text" name="ssn" class="form-control" id="inputscreenname"
						value="${sessionScope.dto.ssn}" readonly="readonly"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<input type="text" name="nickname" class="form-control" id="inputscreenname"
						value="${sessionScope.dto.nickname}"/>
			...
			<div id="btns" align="center" style="margin-bottom: 7px;">
